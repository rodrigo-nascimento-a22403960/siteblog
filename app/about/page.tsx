...
import TextReveal from '@/components/TextReveal'; // IMPORTAR O NOVO
...
const skillCategories = [
  {
    title: "Frontend",
    icon: <Code className="text-[#7cff67]" />,
    skills: ["React", "Next.js", "TypeScript", "Tailwind CSS", "Framer Motion", "Three.js"]
    // Removi os underscores, o TextReveal lida bem com espaços agora
  },
  {
    title: "Backend & Data",
    icon: <Server className="text-purple-400" />,
    skills: ["Node.js", "Python", "PostgreSQL", "MongoDB", "Redis", "Prisma"]
  },
  {
    title: "DevOps & Tools",
    icon: <Terminal className="text-blue-400" />,
    skills: ["Git", "Docker", "AWS", "Linux", "Vercel", "CI/CD"]
  },
  {
    title: "Others",
    icon: <Cpu className="text-orange-400" />,
    skills: ["System Design", "Agile", "UI/UX", "English C1"]
  }
];
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="min-h-screen flex flex-col justify-center relative">
            ...
            >
                ...
                <p>
                    Hello! I'm <strong className="text-white">Rodrigo Nascimento</strong>, a Computer Engineer passionate about building the digital future.
                </p>
            ...
            <motion.div 
                ...
                className="relative w-full max-w-[340px] h-[450px] mx-auto lg:ml-auto z-10"
            >
                <ProfileCard 
        ...
        {/* --- 2. SKILLS (Tech Stack COM NOVO TEXT REVEAL) --- */}
        <motion.div 
          initial="initial"
          whileInView="animate"
          ...
          className="py-32" 
        >
          <motion.h2 variants={fadeInUp} className="text-3xl font-bold mb-16 text-center">
            Tech Stack
          </motion.h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {skillCategories.map((cat, idx) => (
              <motion.div 
                key={idx}
                variants={fadeInUp}
                className="bg-[#0a0a0a] border border-white/5 p-8 rounded-2xl hover:border-[#7cff67]/30 transition-colors duration-300 group min-h-[200px] flex flex-col"
              >
        ...
        <motion.div 
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="bg-gradient-to-r from-[#1a1a1a] to-black border border-white/10 rounded-2xl p-10 text-center relative overflow-hidden mb-32"
        >
